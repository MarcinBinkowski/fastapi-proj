...
# WARNING: Ensure imports from `fastapi_proj` comes after this line
from fastapi_proj import app, settings, db  # noqa
from fastapi_proj.cli import create_user, cli  # noqa
