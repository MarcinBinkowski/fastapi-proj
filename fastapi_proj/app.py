...
description = """
fastapi_proj API helps you do awesome stuff. 🚀
"""
...
app = FastAPI(
    ...
    terms_of_service="http://fastapi_proj.com/terms/",
    contact={
        "name": "MarcinBinkowski",
        "url": "http://fastapi_proj.com/contact/",
        "email": "MarcinBinkowski@fastapi_proj.com",
    },
    license_info={
        "name": "The Unlicense",
